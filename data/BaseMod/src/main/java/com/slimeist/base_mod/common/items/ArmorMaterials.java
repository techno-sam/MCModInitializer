package com.slimeist.base_mod.common.items;
...
public enum ArmorMaterials implements IArmorMaterial {
    SHIMMERING_GOLD(BaseMod.getId("shimmering_gold").toString(), 8, new int[]{1, 3, 5, 2}, 26, SoundEvents.ARMOR_EQUIP_GOLD, 0.0F, 0.0F, () -> {
