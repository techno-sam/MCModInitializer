package com.slimeist.base_mod.client.render.model;
...
@OnlyIn(Dist.CLIENT)
public class SidedModelRenderer {
    ...
    private final ObjectList<SidedModelRenderer.ModelBox> cubes = new ObjectArrayList<>();
    private final ObjectList<SidedModelRenderer> children = new ObjectArrayList<>();
    private HashMap<Direction, Boolean> sides = new HashMap<Direction, Boolean>();

    private void setupSides() {
        this.sides.put(Direction.UP, true);
        this.sides.put(Direction.DOWN, true);
        this.sides.put(Direction.NORTH, true);
        this.sides.put(Direction.SOUTH, true);
        this.sides.put(Direction.EAST, true);
        this.sides.put(Direction.WEST, true);
    }

    public SidedModelRenderer(Model p_i1173_1_) {
        //p_i1173_1_.accept(this);
        this.setupSides();
        this.setTexSize(p_i1173_1_.texWidth, p_i1173_1_.texHeight);
    }

    public SidedModelRenderer(Model p_i46358_1_, int p_i46358_2_, int p_i46358_3_) {
        this(p_i46358_1_.texWidth, p_i46358_1_.texHeight, p_i46358_2_, p_i46358_3_);
        //p_i46358_1_.accept(this);
    }

    public SidedModelRenderer(int p_i225949_1_, int p_i225949_2_, int p_i225949_3_, int p_i225949_4_) {
        this.setupSides();
        this.setTexSize(p_i225949_1_, p_i225949_2_);
        this.texOffs(p_i225949_3_, p_i225949_4_);
    }

    private SidedModelRenderer() {
    }

    public SidedModelRenderer createShallowCopy() {
        SidedModelRenderer modelrenderer = new SidedModelRenderer();
    ...
    public void copyFrom(SidedModelRenderer other) {
        ...
        this.y = other.y;
        this.z = other.z;
        this.sides = (HashMap<Direction, Boolean>) other.sides.clone();
    }

    public void addChild(SidedModelRenderer p_78792_1_) {
        this.children.add(p_78792_1_);
    }

    public SidedModelRenderer setSideVisibility(Direction side, boolean visible) {
        this.sides.put(side, visible);
        return this;
    }

    public SidedModelRenderer texOffs(int p_78784_1_, int p_78784_2_) {
        this.xTexOffs = p_78784_1_;
        this.yTexOffs = p_78784_2_;
        return this;
    }

    public SidedModelRenderer addBox(String p_217178_1_, float p_217178_2_, float p_217178_3_, float p_217178_4_, int p_217178_5_, int p_217178_6_, int p_217178_7_, float p_217178_8_, int p_217178_9_, int p_217178_10_) {
    ...
    public SidedModelRenderer addBox(float p_228300_1_, float p_228300_2_, float p_228300_3_, float p_228300_4_, float p_228300_5_, float p_228300_6_) {
    ...
    public SidedModelRenderer addBox(float p_228304_1_, float p_228304_2_, float p_228304_3_, float p_228304_4_, float p_228304_5_, float p_228304_6_, boolean p_228304_7_) {
    ...
    private void addBox(int p_228305_1_, int p_228305_2_, float p_228305_3_, float p_228305_4_, float p_228305_5_, float p_228305_6_, float p_228305_7_, float p_228305_8_, float p_228305_9_, float p_228305_10_, float p_228305_11_, boolean p_228305_12_, boolean p_228305_13_) {
        this.cubes.add(new SidedModelRenderer.ModelBox(p_228305_1_, p_228305_2_, p_228305_3_, p_228305_4_, p_228305_5_, p_228305_6_, p_228305_7_, p_228305_8_, p_228305_9_, p_228305_10_, p_228305_11_, p_228305_12_, this.xTexSize, this.yTexSize));
    }
    ...
    public void render(MatrixStack p_228309_1_, IVertexBuilder p_228309_2_, int p_228309_3_, int p_228309_4_, float p_228309_5_, float p_228309_6_, float p_228309_7_, float p_228309_8_) {
        if (this.visible) {
            if (!this.cubes.isEmpty() || !this.children.isEmpty()) {
                ...
                for(SidedModelRenderer modelrenderer : this.children) {
    ...
    private void compile(MatrixStack.Entry p_228306_1_, IVertexBuilder p_228306_2_, int p_228306_3_, int p_228306_4_, float p_228306_5_, float p_228306_6_, float p_228306_7_, float p_228306_8_) {
        ...
        for(SidedModelRenderer.ModelBox modelrenderer$modelbox : this.cubes) {
            for(SidedModelRenderer.TexturedQuad modelrenderer$texturedquad : modelrenderer$modelbox.polygons) {
                ...
                Direction normalDirection = Direction.fromNormal((int) normalX, (int) -normalY, (int) -normalZ);
                if (this.sides.get(normalDirection)) {
                    ...
                    for (int i = 0; i < 4; ++i) {
                        SidedModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex = modelrenderer$texturedquad.vertices[i];
    ...
    public SidedModelRenderer setTexSize(int p_78787_1_, int p_78787_2_) {
        this.xTexSize = (float)p_78787_1_;
        this.yTexSize = (float)p_78787_2_;
        return this;
    }

    public SidedModelRenderer.ModelBox getRandomCube(Random p_228310_1_) {
        return this.cubes.get(p_228310_1_.nextInt(this.cubes.size()));
    }

    @OnlyIn(Dist.CLIENT)
    public static class ModelBox {
        private final SidedModelRenderer.TexturedQuad[] polygons;
        ...
        public ModelBox(int p_i225950_1_, int p_i225950_2_, float p_i225950_3_, float p_i225950_4_, float p_i225950_5_, float p_i225950_6_, float p_i225950_7_, float p_i225950_8_, float p_i225950_9_, float p_i225950_10_, float p_i225950_11_, boolean p_i225950_12_, float p_i225950_13_, float p_i225950_14_) {
            ...
            this.polygons = new SidedModelRenderer.TexturedQuad[6];
            ...
            SidedModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex7 = new SidedModelRenderer.PositionTextureVertex(p_i225950_3_, p_i225950_4_, p_i225950_5_, 0.0F, 0.0F);
            SidedModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex = new SidedModelRenderer.PositionTextureVertex(f, p_i225950_4_, p_i225950_5_, 0.0F, 8.0F);
            SidedModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex1 = new SidedModelRenderer.PositionTextureVertex(f, f1, p_i225950_5_, 8.0F, 8.0F);
            SidedModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex2 = new SidedModelRenderer.PositionTextureVertex(p_i225950_3_, f1, p_i225950_5_, 8.0F, 0.0F);
            SidedModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex3 = new SidedModelRenderer.PositionTextureVertex(p_i225950_3_, p_i225950_4_, f2, 0.0F, 0.0F);
            SidedModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex4 = new SidedModelRenderer.PositionTextureVertex(f, p_i225950_4_, f2, 0.0F, 8.0F);
            SidedModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex5 = new SidedModelRenderer.PositionTextureVertex(f, f1, f2, 8.0F, 8.0F);
            SidedModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex6 = new SidedModelRenderer.PositionTextureVertex(p_i225950_3_, f1, f2, 8.0F, 0.0F);
            ...
            this.polygons[2] = new SidedModelRenderer.TexturedQuad(new SidedModelRenderer.PositionTextureVertex[]{modelrenderer$positiontexturevertex4, modelrenderer$positiontexturevertex3, modelrenderer$positiontexturevertex7, modelrenderer$positiontexturevertex}, f5, f10, f6, f11, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.DOWN, 2);
            this.polygons[3] = new SidedModelRenderer.TexturedQuad(new SidedModelRenderer.PositionTextureVertex[]{modelrenderer$positiontexturevertex1, modelrenderer$positiontexturevertex2, modelrenderer$positiontexturevertex6, modelrenderer$positiontexturevertex5}, f6, f11, f7, f10, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.UP, 3);
            this.polygons[1] = new SidedModelRenderer.TexturedQuad(new SidedModelRenderer.PositionTextureVertex[]{modelrenderer$positiontexturevertex7, modelrenderer$positiontexturevertex3, modelrenderer$positiontexturevertex6, modelrenderer$positiontexturevertex2}, f4, f11, f5, f12, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.WEST, 1);
            this.polygons[4] = new SidedModelRenderer.TexturedQuad(new SidedModelRenderer.PositionTextureVertex[]{modelrenderer$positiontexturevertex, modelrenderer$positiontexturevertex7, modelrenderer$positiontexturevertex2, modelrenderer$positiontexturevertex1}, f5, f11, f6, f12, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.NORTH, 4);
            this.polygons[0] = new SidedModelRenderer.TexturedQuad(new SidedModelRenderer.PositionTextureVertex[]{modelrenderer$positiontexturevertex4, modelrenderer$positiontexturevertex, modelrenderer$positiontexturevertex1, modelrenderer$positiontexturevertex5}, f6, f11, f8, f12, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.EAST, 0);
            this.polygons[5] = new SidedModelRenderer.TexturedQuad(new SidedModelRenderer.PositionTextureVertex[]{modelrenderer$positiontexturevertex3, modelrenderer$positiontexturevertex4, modelrenderer$positiontexturevertex5, modelrenderer$positiontexturevertex6}, f8, f11, f9, f12, p_i225950_13_, p_i225950_14_, p_i225950_12_, Direction.SOUTH,5);
        }
    }
    ...
    static class PositionTextureVertex {
        ...
        public SidedModelRenderer.PositionTextureVertex remap(float p_78240_1_, float p_78240_2_) {
            return new SidedModelRenderer.PositionTextureVertex(this.pos, p_78240_1_, p_78240_2_);
        }
    ...
    static class TexturedQuad {
        public final SidedModelRenderer.PositionTextureVertex[] vertices;
        public final Vector3f normal;
        public final int ID;//temp

        public TexturedQuad(SidedModelRenderer.PositionTextureVertex[] p_i225951_1_, float p_i225951_2_, float p_i225951_3_, float p_i225951_4_, float p_i225951_5_, float p_i225951_6_, float p_i225951_7_, boolean p_i225951_8_, Direction p_i225951_9_, int ID) {
            this.ID = ID;
            ...
            if (p_i225951_8_) {
                ...
                for(int j = 0; j < i / 2; ++j) {
                    SidedModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex = p_i225951_1_[j];
